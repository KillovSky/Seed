...
/* Insira comandos aqui se quiser, eles serão adicionados juntos da lista de todos os comandos, se um dia for usar */
let arrayOfCommands = [];
    ...
    try {
        ...
        if (typeof kill === 'object' && typeof message === 'object') {
            ...
            try {
                ...
                console.log('\x1b[31m', 'REPORT THIS TO PROJECT ÍRIS [https://github.com/KillovSky/Seed]!\n', `\x1b[33m${JSON.stringify(message)}`);
